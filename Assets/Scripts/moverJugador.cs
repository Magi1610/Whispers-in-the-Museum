...
public class moverJugador : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // desactivar este script para evitar conflictos de movimiento y físicas.
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (obj.CompareTag("Puntos")) // Si el objeto tiene la etiqueta "Puntos" 
        {
            ...
            Destroy(obj);
            if (puntos >= 30)// Si los puntos del jugador son menores o iguales a 0, cargar la escena de Game Over (escena con �ndice 1)
            {
